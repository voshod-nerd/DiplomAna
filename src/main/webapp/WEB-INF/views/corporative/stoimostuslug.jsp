...
<html>
    ...
    <body ng-app="myApp">
            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse" id="navbar-main">
                    <ul class="nav navbar-nav">
                        <li class="dropdown">
                            <a class="dropdown-toggle" data-toggle="dropdown" href="" id="themes">Cписок действий<span class="caret"></span></a>
        ...
        <div> 
            <div class="generic-container" ng-controller="ControllerStoimUslug as ctrl">
                <div class="panel panel-default">
                    <div class="panel-heading"><span class="lead">Форма редактирования стомости услуг</span></div>
                        ...
                        <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" ng-model="ctrl.unit.summa" 
                                               id="lastname" 
                            ...
                            <div class="row">
                                <div class="form-group col-md-12" ng-controller="ControllerUsl as depctrl">
                                    <label class="col-md-2 control-lable" for="dolg">Вид услуги</label>
                                    <div class="col-md-7">
                                        <select ng-model="ctrl.unit.iduslug" 
                                                id="dolg"
                                                name="dolg">
                ...
                <div class="panel-heading"><span class="lead">Стоимость услуг в зависимости от тарифа</span></div>
                <div class="tablecontainer">
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                <th>Сумма типа номера</th>
                                <th>Вид услуги</th>
                                <th>Вид тарифа</th>
                                <th width="20%"></th>
                            </tr>
                        ...
                        <tbody>
                            <tr ng-repeat="e in ctrl.units">
                                <td><span ng-bind="e.summa"></span></td>
                               
                                <td><span ng-bind="e.iduslug.name"></span></td>
        ...
        <script src="resources/js/service/stoimuslug-service.js"></script>
        <script src="resources/js/controller/stoimuslug-controller.js"></script> 
        <script src="resources/js/service/uslug-service.js"></script>
        <script src="resources/js/controller/uslug-controller.js"></script> 

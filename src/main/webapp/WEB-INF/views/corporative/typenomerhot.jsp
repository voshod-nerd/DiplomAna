...
<html>
    ...
    <body ng-app="myApp">
        ...
        <div> 
            <div class="generic-container" ng-controller="ControllerTN as ctrl">
                <div class="panel panel-default">
                    <div class="panel-heading"><span class="lead">Форма редактирования списка типов отелей</span></div>
                    <div class="formcontainer">
                        <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                            <input type="hidden"  ng-model="ctrl.unit.id" />
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label class="col-md-2 control-lable" for="lastname">Колич. спальных мест</label>
                                    <div class="col-md-7">
                                        <input type="text" ng-model="ctrl.unit.mest" 
                                               id="lastname" 
                          ...
                          <div class="row">
                                <div class="form-group col-md-12">
                                    <label class="col-md-2 control-lable" for="lastname">Тип номера</label>
                                    <div class="col-md-7">
                                        <input type="text" ng-model="ctrl.unit.type" 
                                               id="lastname" 
                                               class="username form-control input-sm" 
                                               placeholder="Введите местоположение" 
                                               required ng-minlength="1"/>
                ...
                <div class="panel-heading"><span class="lead">Список типов номеров</span></div>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <tr ng-repeat="e in ctrl.units">
                                <td><span ng-bind="e.mest"></span></td>
                                <td><span ng-bind="e.type"></span></td>

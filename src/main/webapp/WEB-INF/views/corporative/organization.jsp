                        ...
                        <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label class="col-md-2 control-lable" for="lastname">Наименование</label>
                                    <div class="col-md-7">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label class="col-md-2 control-lable" for="firstname">Штаб-квартира организации</label>
                                    <div class="col-md-7">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label class="col-md-2 control-lable" for="firstname">Электронная почта</label>
                                    <div class="col-md-7">
                                        <input type="text" ng-model="ctrl.unit.mail" 
                                               id="firstname" 
                                               class="username form-control input-sm" 
                                               placeholder="Введите наименование" 
                                               required ng-minlength="2"/>

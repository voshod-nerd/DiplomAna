...
<html>
    ...
    <body ng-app="myApp">
        ...
        <div> 
            <div class="generic-container" ng-controller="ControllerOrg as ctrl">
                <div class="panel panel-default">
                    <div class="panel-heading"><span class="lead">Форма редактирования списка организаций</span></div>
                    <div class="formcontainer">
                        <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                            <input type="hidden"  ng-model="ctrl.unit.id" />
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label class="col-md-2 control-lable" for="lastname">Название</label>
                                    <div class="col-md-7">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label class="col-md-2 control-lable" for="firstname">Адрес</label>
                                    <div class="col-md-7">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label class="col-md-2 control-lable" for="firstname">ФИО представителя</label>
                                    <div class="col-md-7">
                                        <input type="text" ng-model="ctrl.unit.fiopredstavitel" 
                                               id="firstname" 
                                               class="username form-control input-sm" 
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label class="col-md-2 control-lable" for="firstname">ИНН организации</label>
                                    <div class="col-md-7">
                                        <input type="text" ng-model="ctrl.unit.inn" 
                                               id="firstname" 
                                               class="username form-control input-sm" 
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label class="col-md-2 control-lable" for="firstname">КПП организации</label>
                                    <div class="col-md-7">
                                        <input type="text" ng-model="ctrl.unit.kpp" 
                                               id="firstname" 
                                               class="username form-control input-sm" 
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th>Местоположение штаб-квартиры</th>
                        ...
                        <tbody>
                            <tr ng-repeat="e in ctrl.units| filter:ctrl.searchFish">
                                ...
                                <td><span ng-bind="e.fiopredstavitel"></span></td>
                                <td><span ng-bind="e.inn"></span></td>
                                <td><span ng-bind="e.kpp"></span></td>
                                <td><span ng-bind="e.mail"></span></td>

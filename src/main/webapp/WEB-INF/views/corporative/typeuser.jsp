...
<html>
    ...
    <body ng-app="myApp">
        ...
        <div> 
            <div class="generic-container" ng-controller="ControllerTypeUser as ctrl">
                <div class="panel panel-default">
                    <div class="panel-heading"><span class="lead">Форма редактирования списка типов пользователей</span></div>
                ...
                <div class="panel-heading"><span class="lead">Список дополнительных типов пользователей</span></div>
        ...
        <script src="resources/js/service/typeuser-service.js"></script>
        <script src="resources/js/controller/typeuser-controller.js"></script> 
    </body>
</html>
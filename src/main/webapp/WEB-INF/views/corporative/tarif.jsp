...
<html>
    ...
    <body ng-app="myApp">
        ...
        <div> 
            <div class="generic-container" ng-controller="ControllerTarif as ctrl">
                <div class="panel panel-default">
                    <div class="panel-heading"><span class="lead">Форма тарифов</span></div>
                    <div class="formcontainer">
                        <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                            <input type="hidden"  ng-model="ctrl.unit.id" />
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label class="col-md-2 control-lable" for="lastname">Название тарифа</label>
                                    <div class="col-md-7">
                ...
                <div class="panel-heading"><span class="lead">Список тарифов</span></div>

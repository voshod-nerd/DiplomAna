...
<html>
    ...
    <body ng-app="myApp">
       <div class="navbar navbar-default navbar-fixed-top">
        ...
        <br>
        <div> 
            <div class="generic-container" ng-controller="ControllerPitan as ctrl">
                <div class="panel panel-default">
                    <div class="panel-heading"><span class="lead">Форма редактирования видов питания</span></div>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" ng-model="ctrl.unit.name" 
                                               ...
                                               placeholder="Введите вид питания" 

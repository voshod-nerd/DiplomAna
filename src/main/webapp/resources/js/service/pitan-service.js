...
App.factory('ServicsPitan', ['$http', '$q', function ($http, $q) {
        ...
        return { 
            fetchAllU: function () {
                return $http.get('/vc/restpitanie')
                        .then(
                                function (response) {
            ...
            createU: function (unit) {
                return $http.post('/vc/restpitanie/item',
                        JSON.stringify(unit))
                        .then(
                                function (response) {
                                    return response.data;
            ...
            updateU: function (unit) {
                return $http.put('/vc/restpitanie/item',
                        JSON.stringify(unit))
                        .then(
                                function (response) {
                                    return response.data;

...
App.factory('ServicsProg', ['$http', '$q', function ($http, $q) {
        ...
        return { 
            fetchAllU: function () {
                return $http.get('/vc/restprogram')
                        .then(
                                function (response) {
            ...
            createU: function (unit) {
                return $http.post('/vc/restprogram/item',
                        JSON.stringify(unit))
                        .then(
                                function (response) {
                                    return response.data;
            ...
            updateU: function (unit) {
                return $http.put('/vc/restprogram/item',
                        JSON.stringify(unit))
                        .then(
                                function (response) {
                                    return response.data;

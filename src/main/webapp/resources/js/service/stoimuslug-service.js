...
App.factory('ServicsStoimostUslug', ['$http', '$q', function ($http, $q) {
        ...
        return { 
            fetchAllU: function () {
                return $http.get('/vc/reststoimostuslug')
                        .then(
                                function (response) {
            ...
            createU: function (unit) {
                return $http.post('/vc/reststoimostuslug/item',
                        JSON.stringify(unit))
                        .then(
                                function (response) {
                                    return response.data;
            ...
            updateU: function (unit) {
                return $http.put('/vc/reststoimostuslug/item',
                        JSON.stringify(unit))
                        .then(
                                function (response) {
                                    return response.data;

...
App.factory('ServicsTN', ['$http', '$q', function ($http, $q) {
        ...
        return { 
            fetchAllU: function () {
                return $http.get('/vc/resttypenomerhotel')
                        .then(
                                function (response) {
            ...
            createU: function (unit) {
                return $http.post('/vc/resttypenomerhotel/item',
                        JSON.stringify(unit))
                        .then(
                                function (response) {
                                    return response.data;
            ...
            updateU: function (unit) {
                return $http.put('/vc/resttypenomerhotel/item',
                        JSON.stringify(unit))
                        .then(
                                function (response) {
                                    return response.data;
            ...
            deleteU: function (unit) {
                return $http({method: 'DELETE',
                    url: '/vc/resttypenomerhotel/item/',

...
App.factory('ServicsEmployee', ['$http', '$q', function ($http, $q) {
        ...
        return { 
            ...
            createU: function (unit) {
                return $http.post('/vc/restuser/item',
                        JSON.stringify(unit))
                        .then(
                                function (response) {
                                    return response.data;
            ...
            updateU: function (unit) {
                return $http.put('/vc/restuser/item',
                        JSON.stringify(unit))
                        .then(
                                function (response) {
                                    return response.data;

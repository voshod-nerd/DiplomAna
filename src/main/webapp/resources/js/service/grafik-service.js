...
App.factory('ServicsGrafik', ['$http', '$q', function ($http, $q) {
        ...
        return { 
            ...
            createU: function (unit) {
                return $http.post('/vc/restgrafik/item',
                        JSON.stringify(unit))
                        .then(
                                function (response) {
                                    return response.data;
            ...
            updateU: function (unit) {
                return $http.put('/vc/restgrafik/item',
                        JSON.stringify(unit))
                        .then(
                                function (response) {
                                    return response.data;

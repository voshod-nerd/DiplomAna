...
App.factory('ServicsStoimostPitan', ['$http', '$q', function ($http, $q) {
        ...
        return { 
            fetchAllU: function () {
                return $http.get('/vc/reststoimostpitan')
                        .then(
                                function (response) {
            ...
            createU: function (unit) {
                return $http.post('/vc/reststoimostpitan/item',
                        JSON.stringify(unit))
                        .then(
                                function (response) {
                                    return response.data;
            ...
            updateU: function (unit) {
                return $http.put('/vc/reststoimostpitan/item',
                        JSON.stringify(unit))
                        .then(
                                function (response) {
                                    return response.data;

...
public class UserRoles implements Serializable {
    ...
    @Column(name = "role")
    private String role;
    @JoinColumn(name = "idusername", referencedColumnName = "username")
    @ManyToOne(optional = false)
    private Employee idusername;
    ...
    public Employee getIdusername() {
        return idusername;
    }

    public void setIdusername(Employee idusername) {

...
public class RestControllerUser {
    ...
    public List<Employee> getUnitList() {
    ...
    public Employee createU(@RequestBody Employee zav) {
    ...
    @RequestMapping(method = RequestMethod.PUT,
            path = ITEM_PATH,
            consumes = MediaType.APPLICATION_JSON_VALUE)
    public Employee updateU(@RequestBody Employee zav) {
    ...
    @RequestMapping(method = RequestMethod.DELETE,
            path = ITEM_PATH,
            consumes = MediaType.APPLICATION_JSON_VALUE)
    public void deleteU(@RequestBody Employee zav) {
        uService.delete(zav);
    }
}
